...
const Screen3 = () => {
  ...
  const [options, setOptions] = useState([
    { selected: true, value: "देश" },
    { selected: false, value: "विदेश" },
    { selected: false, value: "व्यापार" },
    { selected: false, value: "वुमन" },
    { selected: false, value: "बॉलीवुड" },
    { selected: false, value: "स्पोर्ट्स" },
    { selected: false, value: "बिजनेस" },
    { selected: false, value: "करियर" },
    { selected: false, value: "मैगज़ीन" },
    { selected: false, value: "राशिफल" },
    { selected: false, value: "लाइफ साइंस" },
    { selected: false, value: "टेक्नोलॉजी" },
  ]);
  ...
  //     var config = {
  //         method: 'get',
  //         url: 'https://maps.googleapis.com/maps/api/place/autocomplete/json?input=amoeba&types=establishment&location=37.76999%2C-122.44696&radius=500&key=AIzaSyDJXV6a8WTFQWRtiOe0Dz3i3tiWg96M4c0',
  //         headers: { }
  //       };
            ...
            {options.map((option, index) => (
              ...
              >
                <View
                  style={[
                    styles.optionCircle,
                    option.selected && { backgroundColor: "blue" },
                  ]}
                ></View>
                <Text style={styles.options}>{option.value}</Text>
              </TouchableOpacity>
            ))}
          </View>
        )}
